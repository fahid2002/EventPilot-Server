...
async function seed() {
  ...
  const password = await bcrypt.hash("TypeScript@123", 12);
  const demoPassword = await bcrypt.hash("Demo@123", 12);

  const [fahid, organizer, admin, demo] = await User.create([
    { name: "Fahid Hasan", email: "fahid@example.com", password, role: "user", membership: "free", photoUrl: "" },
    { name: "EventPilot Organizer", email: "organizer@eventpilot.dev", password, role: "organizer", membership: "premium", photoUrl: "" },
    { name: "EventPilot Admin", email: "admin@eventpilot.dev", password, role: "admin", membership: "premium", photoUrl: "" },
    { name: "Demo Visitor", email: "demo@eventpilot.dev", password: demoPassword, role: "user", membership: "free", isDemo: true, photoUrl: "" }
  ]);
  ...
  const events = await Event.create([
    {
      ...
      category: "Web Development", location: "Dhaka", date: new Date("2026-07-24"), price: 1500, accessType: "premium", status: "approved", imageUrl: images.next, gallery: [images.next], rating: 4.9, capacity: 120, organizerId: organizer._id, organizerName: organizer.name, tags: ["Next.js", "TypeScript", "MongoDB"]
    },
    {
      ...
      category: "AI & Data", location: "Chattogram", date: new Date("2026-08-08"), price: 2200, accessType: "premium", status: "approved", imageUrl: images.ai, gallery: [images.ai], rating: 4.7, capacity: 180, organizerId: organizer._id, organizerName: organizer.name, tags: ["AI", "Career", "Portfolio"]
    },
    {
      ...
      category: "Web Development", location: "Sylhet", date: new Date("2026-08-14"), price: 1200, accessType: "free", status: "approved", imageUrl: images.mongo, gallery: [images.mongo], rating: 4.8, capacity: 90, organizerId: organizer._id, organizerName: organizer.name, tags: ["MongoDB", "Express", "API"]
    },
    {
      ...
      category: "UI/UX Design", location: "Online", date: new Date("2026-08-20"), price: 0, accessType: "free", status: "approved", imageUrl: images.ui, gallery: [images.ui], rating: 4.6, capacity: 75, organizerId: organizer._id, organizerName: organizer.name, tags: ["UI", "UX", "Portfolio"]
    },
    {
      ...
      category: "Career", location: "Dhaka", date: new Date("2026-09-03"), price: 800, accessType: "free", status: "approved", imageUrl: images.career, gallery: [images.career], rating: 4.5, capacity: 60, organizerId: organizer._id, organizerName: organizer.name, tags: ["Interview", "React", "Career"]
    },
    {
      ...
      category: "AI & Data", location: "Online", date: new Date("2026-09-09"), price: 900, accessType: "premium", status: "approved", imageUrl: images.charts, gallery: [images.charts], rating: 4.7, capacity: 100, organizerId: organizer._id, organizerName: organizer.name, tags: ["Recharts", "Data", "Dashboard"]
    },
    {
      ...
      category: "Web Development", location: "Dhaka", date: new Date("2026-10-05"), price: 1800, accessType: "premium", status: "pending", imageUrl: images.tailwind, gallery: [images.tailwind], rating: 4.6, capacity: 100, organizerId: organizer._id, organizerName: organizer.name, tags: ["React", "Patterns", "Professional"]
    }
  ]);
  ...
  console.log("User: fahid@example.com / TypeScript@123");
  console.log("Organizer: organizer@eventpilot.dev / TypeScript@123");
  console.log("Admin: admin@eventpilot.dev / TypeScript@123");
  console.log("Demo: demo@eventpilot.dev / Demo@123");
  process.exit(0);
}
